    ...
    */
    ...
    public :
        ...
        */
        ...
        /*!
            \brief Verifie certaines contraintes pour poser un pres de maniere adjacente a un environnement donne
            \param[in] env Environnement adjacent dont on veut verifier la possibilite 
            \return <tt>true</tt> si le batiment courant peut etre adjacent a env, <tt>false</tt> sinon
            \note Un pre peut etre adjacent a un autre pre s'il n'a pas meeple dessus
        */
