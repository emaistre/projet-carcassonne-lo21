    ...
    */
	...
	public:
        ...
        */
        ...
        /*! \brief Donne le nombre d'Abbes le joueurs possede
            \return Le nombre d'Abbes en la possession du joueur
        */
        ...
        /*! \brief Donne le nombre de Grands Meeples le joueurs possede
            \return Le nombre de Grands Meeples en la possession du joueur
        */
