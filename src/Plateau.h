...
namespace Carcassonne {
    ...
    */
	...
	private:
        ...
        std::vector<extensions> ext; /*!< Liste des extensions de cette partie */
	...
	public:
        ...
        /*!
            ...
            \brief[in] extensionListe Liste des extensions acceptees dans cette partie
        */
        ...
        */
        ...
        /*! \brief Passe a la tuile suivante */
        void nextTuile() {
            tuileCourante = pioche.piocher();
        }

        /*! \brief Tourne la tuile courante a droite */
        ...
        /*! \brief Tourne la tuile courante a gauche */
        ...
        */
        ...
        /*!
            \brief Recupere les emplacements ou l'on peut poser un meeple
            \param[in] coordTuile Coordonnee de l'environnement dans la Tuile
            \return Liste des coordonnees ou un meeple peut etre posee
        */
        ...
        */
        ...
        /*!
            \brief Pose un meeple dans un certain environnement
            \param[in] m Pointeur sur le meeple a poser
            \param[in] env Pointeur sur l'environnement sur lequel poser le meeple
            \return Pointeur sur le meeple pose
        */
