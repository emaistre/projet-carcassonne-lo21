    ...
    */
    ...
    public :
        ...
        */
        ...
        /*! \brief Recupere le meeple lie a un environnement
            \return Pointeur sur le meeple de l'environnement
        */
        ...
        */
        ...
        /*! \brief Inidique si l'on peut poser un meeple 
            \return <tt>true</tt> Si on peut poser un meeple, <tt>false</tt> sinon
        */
        virtual bool peutPoserMeeple() const {
            return true;
        }

        /*! \brief Verifie des contraintes par rapport a un autre environnement
         *  \param[in] env L'environnement a verifier
            \return <tt>true</tt> Si la contrainte est respectee, <tt>false</tt> sinon
        */
