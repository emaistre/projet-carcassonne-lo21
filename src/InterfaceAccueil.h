...
namespace Carcassonne {
    ...
    /*! \class InterfaceAccueil
        \brief Represente l'interface d'accueil
    */
    ...
    public:
        ...
        /*!
            ...
            \param[in,out] parent Le widget parent
        */
    ...
    private slots:
        ...
        /*! Commence une partie avec avoir clique sur le bouton associe */
