    ...
    */
    ...
    public:
        ...
        */
        ...
        /*!
            \brief Indique s'il y a un meeple sur la Tuile
            \return <tt>true</tt> s'il y a un meeple sur la Tuile, <tt>false</tt> sinon
        */
        ...
        */
        ...
        /*!
            \brief Recupere le Meeple present sur la Tuile
            \return Un pointeur sur le meeple pose sur la Tuile ou nullptr s'il n'y en n'a pas
        */
        ...
        /*!
            \brief Recupere un environnement a certaines coordonnees
            \param[in] c Les coordonnees dont on veut recuperer l'environnement
            \return Un pointeur sur l'environnement situe a un endroit particulier
        */
        Environnement* getEnvironnement(const Coordonnee& c) const {
            // Verifie que les coordonnes sont dans les cordes
        ...
        */
        ...
        /*!
            \brief Recupere les emplacements ou il est possible de poser un meeple
            \return Liste des coordonnes des environnements sur lesquels on peut poser un Meeple
        */
        Coordonnees recupEmplacementsOuMeeplesPosables() const;

        /*!
            \brief Verifie s'il est possible de poser un meeple sur un environnement sur cette Tuile
            \param[in] e L'environnement que l'on veut verifier
            \return <tt>true</tt> s'il est possible de poser l'environnement, <tt>false</tt> sinon
        */
